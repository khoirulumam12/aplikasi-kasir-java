...
public class Pengeluaran extends javax.swing.JFrame {
    ...
    public Pengeluaran() {
        initComponents();
        tampilTanggal(); // Tampilkan tanggal hari ini otomatis
        tampilData();    // Tampilkan data tabel
        reset();         // Reset form
        setLocationRelativeTo(null);
    }
    
    // --- 1. METHOD TAMPIL TANGGAL OTOMATIS ---
    private void tampilTanggal() {
        Date tgl = new Date();
        SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd"); // Format Database
    ...
    // --- 3. METHOD TAMPIL DATA & HITUNG TOTAL ---
    private void tampilData() {
        DefaultTableModel model = (DefaultTableModel) tbl_Pengeluaran.getModel();
        model.setRowCount(0); // Bersihkan tabel
        kursIndo.setMaximumFractionDigits(0); // Hilangkan ,00 di belakang

        double total = 0;
        int no = 1;

        try {
            String sql = "SELECT * FROM tbl_pengeluaran ORDER BY id DESC";
            ...
            while (rs.next()) {
                ...
                total += jml; // Hitung Total

                Object[] data = {
                    no++,
                    id, // Kolom ID (Bisa disembunyikan jika mau)
                    tgl,
                    ket,
                    kursIndo.format(jml)
                };
    ...
    private void initComponents() {
        ...
        jLabel1.setText("PENGELUARAN OPERASIONAL");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(btn_Tutup, javax.swing.GroupLayout.PREFERRED_SIZE, 127, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(34, 34, 34))
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addComponent(txt_Total, javax.swing.GroupLayout.PREFERRED_SIZE, 325, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(txt_Keterangan, javax.swing.GroupLayout.DEFAULT_SIZE, 178, Short.MAX_VALUE)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGap(14, 14, 14)
                                .addComponent(lbl_Tanggal, javax.swing.GroupLayout.PREFERRED_SIZE, 78, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void btn_SimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_SimpanActionPerformed
        ...
        try {
            String sql = "INSERT INTO tbl_pengeluaran (tanggal, keterangan, jumlah) VALUES (?, ?, ?)";
            ps = conn.prepareStatement(sql);
            
            ps.setString(1, lbl_Tanggal.getText());
            ps.setString(2, txt_Keterangan.getText());
            
            // Bersihkan format titik/koma dari input jumlah
            String jmlMurni = txt_Jumlah.getText().replaceAll("[^0-9]", "");
            ps.setString(3, jmlMurni);
            
            ps.executeUpdate();
            JOptionPane.showMessageDialog(null, "Data Pengeluaran Tersimpan");
    ...
    private void btn_HapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_HapusActionPerformed
        ...
        if (confirm == 0) {
            try {
                // Ambil ID dari tabel (Kolom index 1 sesuai urutan di tampilData)
                String id = tbl_Pengeluaran.getValueAt(selectedRow, 1).toString();
